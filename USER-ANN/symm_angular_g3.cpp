...
double PhiA_G3::operator()(double cos, double rij, double rik, double rjk)const{
	return angle(cos)*dist(rij,rik,rjk);
}

double PhiA_G3::val(double cos, double rij, double rik, double rjk)const{
	return angle(cos)*dist(rij,rik,rjk);
}
...
double PhiA_G3::dist(double rij, double rik, double rjk)const{
...
double PhiA_G3::grad_dist_0(double rij, double rik, double rjk)const{
...
double PhiA_G3::grad_dist_1(double rij, double rik, double rjk)const{
...
double PhiA_G3::grad_dist_2(double rij, double rik, double rjk)const{
