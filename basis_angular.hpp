...
public:
	...
	static void init_G3P(BasisA& basis, unsigned int nA, CutoffN::type tcut, double rcut);
	static void init_G4P(BasisA& basis, unsigned int nA, CutoffN::type tcut, double rcut);
	//loading/printing
