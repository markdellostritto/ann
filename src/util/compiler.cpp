...
/**
* @return the C++ standard used when compiling the code
*/
std::string standard(){
	std::string str;
	#ifdef __cplusplus
...
/**
* @return the name of the compiler used
*/
std::string name(){
	std::string str;
	//clang
...
/**
* @return the architecture the code is compiled on
*/
std::string arch(){
	std::string str;
	#if defined __i386__
...
/**
* @return any instruction sets which have been specified
*/
std::string instr(){
	std::string str;
	#if defined __AVX__
...
/**
* @return whether OpenMP has been activated
*/
std::string omp(){
...
/**
* @return the operating system the code was compiled on
*/
std::string os(){
	std::string str;
