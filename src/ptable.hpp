...
static const unsigned int N_ELEMENTS=118;
...
static const float MASS[N_ELEMENTS]={
...
static const float RADIUS_ATOMIC[N_ELEMENTS]={
...
static const float RADIUS_COVALENT[N_ELEMENTS]={
...
double mass(int an);
//==== RADIUS ====
double radius_atomic(int an);
double radius_cov(int an);
