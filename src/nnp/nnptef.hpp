...
public:
	...
	//nnp
		...
		std::vector<Eigen::VectorXd> gradIJ_;     //gradients - subset for each element (nElements)
		std::vector<Eigen::VectorXd> gradIK_;     //gradients - subset for each element (nElements)
