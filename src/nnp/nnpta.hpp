...
public:
	...
	//batch
		...
		std::vector<Eigen::Vector3d> vect_;
		std::vector<Eigen::Vector3d> vecv_;
	//optimization
...
public:
	...
	void error_cost0(const Eigen::VectorXd& x, std::vector<Structure>& struc_train, std::vector<Structure>& struc_val);//compute error for a potential
	void error_cost1(const Eigen::VectorXd& x, std::vector<Structure>& struc_train, std::vector<Structure>& struc_val);//compute error for a potential
	void error_cost2(const Eigen::VectorXd& x, std::vector<Structure>& struc_train, std::vector<Structure>& struc_val);//compute error for a potential
	void error_cost3(const Eigen::VectorXd& x, std::vector<Structure>& struc_train, std::vector<Structure>& struc_val);//compute error for a potential
