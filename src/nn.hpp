...
struct TransferFFDV{
	static void f_lin(VecX& f, VecX& d)noexcept;
	static void f_sigmoid(VecX& f, VecX& d)noexcept;
	static void f_tanh(VecX& f, VecX& d)noexcept;
	static void f_isru(VecX& f, VecX& d)noexcept;
	static void f_arctan(VecX& f, VecX& d)noexcept;
	static void f_softsign(VecX& f, VecX& d)noexcept;
	static void f_relu(VecX& f, VecX& d)noexcept;
	static void f_softplus(VecX& f, VecX& d)noexcept;
	static void f_softplus2(VecX& f, VecX& d)noexcept;
	static void f_elu(VecX& f, VecX& d)noexcept;
	static void f_gelu(VecX& f, VecX& d)noexcept;
};
...
public:
	...
	//error
		...
		VecX& dcdo(const VecX& output, VecX& grad)const;
	//info
		int size()const;
		int nBias()const;
		int nWeight()const;
	...
	//execution
		const VecX& execute();
		const VecX& execute(const VecX& in){in_=in;return execute();}
		void grad_out();
