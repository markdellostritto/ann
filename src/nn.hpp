...
struct LossN{
	...
	static type read(const char* str);
	static const char* name(const LossN::type& tf);
};
std::ostream& operator<<(std::ostream& out, const LossN::type& tf);
...
struct TransferFFDV{
	static void f_lin(VecXd& f, VecXd& d)noexcept;
	static void f_sigmoid(VecXd& f, VecXd& d)noexcept;
	static void f_tanh(VecXd& f, VecXd& d)noexcept;
	static void f_isru(VecXd& f, VecXd& d)noexcept;
	static void f_arctan(VecXd& f, VecXd& d)noexcept;
	static void f_softsign(VecXd& f, VecXd& d)noexcept;
	static void f_relu(VecXd& f, VecXd& d)noexcept;
	static void f_softplus(VecXd& f, VecXd& d)noexcept;
	static void f_softplus2(VecXd& f, VecXd& d)noexcept;
	static void f_elu(VecXd& f, VecXd& d)noexcept;
	static void f_gelu(VecXd& f, VecXd& d)noexcept;
};
...
private:
	...
	rng::dist::Name::type distT_;//distribution type
...
public:
	...
	rng::dist::Name::type& distT(){return distT_;}
	const rng::dist::Name::type& distT()const{return distT_;}
...
public:
	...
	//==== access ====
	LossN::type& lossT(){return lossT_;}
	const LossN::type& lossT()const{return lossT_;}
